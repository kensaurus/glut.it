...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(L):
        ...
        parameters["W" + str(l+1)] -= learning_rate*(v_corrected["dW" + str(l+1)]/(np.power(s_corrected["dW" + str(l+1)],0.5)+epsilon))
        parameters["b" + str(l+1)] -= learning_rate*(v_corrected["db" + str(l+1)]/(np.power(s_corrected["db" + str(l+1)],0.5)+epsilon))
